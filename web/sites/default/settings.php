...
$filename = sprintf('%s/%s/settings.%s.php', $app_root, $site_path, $environment);
 ...
 * Reverse proxy:
 *
 * Fix issue when all requests are being logged in db from same internal docker containter ip.
 */
$settings['reverse_proxy'] = TRUE;
